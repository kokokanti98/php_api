...
if($num>0){
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
        ...
        $medicament_item=array(
       	...
       	if($code!=null){
			array_push($medicaments_arr["records"], $medicament_item);
		}
    }
    ...
    echo json_encode(
        array("message" => "No medicament found.")
    );
}