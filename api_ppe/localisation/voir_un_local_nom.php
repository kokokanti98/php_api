...
$localisation->libelleVille = isset($_GET['libelleVille']) ? $_GET['libelleVille'] : die();

//$localisation->num_article = $data->num_article;

var_dump($localisation->libelleVille);
...
$localisation->voir_un_seul_nom();
 
if($localisation->libelleVille!=null){
    // create array
