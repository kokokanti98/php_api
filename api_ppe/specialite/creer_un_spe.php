...
if(
    !empty($data->id_specialite) &&
	!empty($data->nom_specialite)
){
    ...
    if($specialite->creer()){
		...
		//var_dump($data->numero_specialite);
		//var_dump($data->date_envoie);
        echo json_encode(array("message" => "specialite was created."));
    }
    ...
    // if unable to create the product, tell the user
        ...
        // tell the user
        echo json_encode(array("message" => "Unable to create specialite."));
    }
}
...
// tell the user data is incomplete
    ...
    echo json_encode(array("message" => "Unable to create specialite. Data is incomplete."));
}
?>